				...
				<div ref={measureRef} className="flex min-h-0 flex-1 overflow-hidden">
					...
					{wide &&
						(activeEntry && active ? (
							...
							<div className="mx-2 mb-2 mt-1 flex min-h-0 min-w-0 flex-1 flex-col items-center justify-center gap-2 rounded-xl border border-border/70 bg-background text-muted-foreground">
