...
// Overridable at link time via -X main.executableName=... / -X main.appDataDirName=...
var executableName = "Vetta.exe"
var appDataDirName = "Vetta"
...
func main() {
	...
	localRoot := filepath.Join(localAppData, appDataDirName)
