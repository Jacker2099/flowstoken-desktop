...
export const PLUGIN_EXECUTION_CHANNELS = {
	...
	CLI_PROVIDER_STATUS_GET: "vetta:plugins:cli-provider:status-get",
	CLI_PROVIDER_STATUS: "vetta:plugins:cli-provider:status",
	CLI_PROVIDER_RETRY: "vetta:plugins:cli-provider:retry",
	CLI_PROVIDER_RUN: "vetta:plugins:cli-provider:run",
	CLI_PROVIDER_SPAWN: "vetta:plugins:cli-provider:spawn",
	CLI_PROVIDER_SPAWN_STOP: "vetta:plugins:cli-provider:spawn-stop",
	CLI_PROVIDER_SPAWN_STATUS: "vetta:plugins:cli-provider:spawn-status",
	CLI_PROVIDER_SPAWN_EXIT: "vetta:plugins:cli-provider:spawn-exit",
	SERVICE_STATUS_GET: "vetta:plugins:service:status-get",
	SERVICE_STATUS: "vetta:plugins:service:status",
	SERVICE_PLATFORM_GET: "vetta:plugins:service:platform-get",
	SERVICE_INSTALL: "vetta:plugins:service:install",
	SERVICE_START: "vetta:plugins:service:start",
	SERVICE_STOP: "vetta:plugins:service:stop",
	...
	STORAGE_READ_SNAPSHOT: "vetta:plugins:storage:read-snapshot",
	STORAGE_COMMIT: "vetta:plugins:storage:commit",
